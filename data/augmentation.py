...
from .utils import crop_scale_3d, flip_data
    
class AugmenterInput:
    """
        Make 2D augmentations on the fly. PyTorch batch-processing GPU version.
    """
    def __init__(self, noise_parameters, mask_ratio, mask_T_ratio):
        self.noise = noise_parameters
...
class Augmenter3D:
    ...
    """
    def __init__(self, flip, scale_range_pretrain=None):
        self.flip = flip
        self.scale_range_pretrain = scale_range_pretrain
